...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      width: {
        dynamicHelperBox:
          "clamp(2.5rem, calc(2.5rem + ((1vw - 0.2rem) * 0.5)), 3rem);",
        dynamicIcon:
          "clamp(2.5rem, calc(2.5rem + ((1vw - 0.2rem) * 0.5)), 3rem);",
        dynamicSocialIcon:
          "clamp(2rem, calc(2rem + ((1vw - 0.2rem) * 0.5)), 2.5rem);",
      },
      height: {
        dynamicHelperBox:
          "clamp(2.5rem, calc(2.5rem + ((1vw - 0.2rem) * 0.5)), 3rem);",
      ...
      padding: {
        dynamicCalendarDay:
          "clamp(0.5rem, calc(0.5rem + ((1vw - 0.2rem) * 0.5)), 1rem);",
      },
      translate: {
        dynamicFormY: "clamp(1.450rem, 1.75vw, 1.75rem)",
      },
      screens: {
        mobile: "768px",
        tablet: "992px",
