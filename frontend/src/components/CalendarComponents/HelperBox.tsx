    ...
    <div className="w-11/12 max-w-[1920px]  bg-[#644632] p-4 rounded-3xl flex items-center justify-center">
      <ul className="flex gap-4 flex-wrap text-dynamicList w-full">
        <AnimationOnScroll
          ...
          className="flex gap-4 items-center text-palette-2 font-medium  w-max"
        >
        ...
        <AnimationOnScroll
          ...
          animatePreScroll={false}
          animateIn={"animate__fadeInUp"}
          className="flex gap-4 order-6 items-center text-palette-2 font-medium w-max "
        >
        ...
        <AnimationOnScroll
          ...
          animatePreScroll={false}
          animateIn={"animate__fadeInUp"}
          className="flex gap-4 order-9 items-center text-palette-2 font-medium w-max "
        >
        ...
        <AnimationOnScroll
          ...
          animatePreScroll={false}
          animateIn={"animate__fadeInUp"}
          className="flex gap-4 order-7 items-center text-palette-2 font-medium w-max "
        >
        ...
        <AnimationOnScroll
          ...
          animatePreScroll={false}
          animateIn={"animate__fadeInUp"}
          className="flex gap-4 order-8 items-center text-palette-2 font-medium w-max "
        >
        ...
        <AnimationOnScroll
          ...
          animatePreScroll={false}
          animateIn={"animate__fadeInUp"}
          className="flex gap-4 order-5  items-center text-palette-2 font-medium w-max "
        >
