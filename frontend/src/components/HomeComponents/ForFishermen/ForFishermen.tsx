    ...
    <section className="w-full overflow-hidden">
      <article className="fishermenBg-gradient flex flex-col items-center w-full relative">
        <AnimationOnScroll
          ...
          className="py-4 flex justify-center flex-col text-center text-palette-4"
        >
          <h2 className="text-dynamicTitle2 font-semibold  z-50">
            Horgászni vágyóknak!
          </h2>
          <p className="text-dynamicDesc font-bold">A közelben lévő tavak</p>
        </AnimationOnScroll>
