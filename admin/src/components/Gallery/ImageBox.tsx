        ...
        imageSrc.map((img, index) => (
          <div className="w-full mobile:w-[calc(33%-.8rem)] tablet:w-[calc(25%-.8rem)] laptop:w-[calc(20%-.8rem)] flex flex-col rounded-3xl overflow-hidden shadow-shadow relative">
            <input
              ...
              type="checkbox"
              id={img.id}
              className="absolute z-10 top-[calc(1.25rem/2)] right-[calc(1.25rem/2)] w-5 h-5 rounded-md outline-none bg-white checked:bg-[#636060] active:ring-0 active:ring-transparent focus:ring-0 focus:ring-transparent cursor-pointer transition-all ease-in-out duration-300"
            />
            <label
              htmlFor={img.id}
